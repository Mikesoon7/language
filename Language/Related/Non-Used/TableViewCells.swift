//
//  MenuDictionaryCVCell.swift
//  Learny
//
//  Created by Star Lord on 20/12/2024.
//
...
//            equalTo: mainView.trailingAnchor, constant: initialActionConstant)
//        
//        finalStatConstant = -(contentViewWidth * 0.2) - 0.5
...
//        
//        statViewInitialLeadingAnchor = statisticView.leadingAnchor.constraint(equalTo: statView.leadingAnchor, constant: ViewConstants.cornerRadius)
...
////        if statisticView.superview != nil {
////            animateTransitionToStat(activate: false)
////        }
//        activate(false)
//    }
